...
const Privacy = () => {
  return (
    <Layout>
        ...
        This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from rembux.netlify.app (the “Site”).
        ...
        CONTACT US
        For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at rembux.dev@gmail.com or by mail using the details provided below:

        Jineman Girikerto Turi, Sleman, YO, 55551, Indonesia
        </textarea>
        </div>
    </Layout>
  );
